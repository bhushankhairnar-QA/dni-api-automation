 ...
 *
 * <p>Standard test methods use {@link #createProject(Map)} and {@link #deleteProject(String)},
 * which operate on the pre-built {@code lyticsRequestSpec}.  Header-validation tests that need
