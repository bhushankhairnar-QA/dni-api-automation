...
public class PostsApiTest extends LyticsBaseApiTest {
    ...
    public void TC_001_Send_POST_request_with_valid_project_name() {
        ...
        Response response =
                given()
                        ...
                        .body(LyticsProjectTestData.validFullProjectCreatePayload())
                        .when()
    ...
    public void TC_002_Send_POST_request_without_project_name_field() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithoutName())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_003_Send_POST_request_with_empty_string_as_project_name() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithEmptyName())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_004_Send_POST_request_with_only_spaces_in_project_name() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithSpaceOnlyName())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_005_Send_POST_request_with_project_name_length_exactly_200_characters() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithMaxLengthName())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_006_Send_POST_request_with_project_name_length_more_than_200_characters() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithNameOverMaxLength())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_007_Send_POST_request_with_duplicate_project_name() {
        ...
        Response createResponse =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithName(uniqueName))
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_008_Send_POST_request_with_project_name_having_special_characters() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.validFullProjectCreatePayloadWithName(
    ...
    @Test(
            priority = 10,
            description =
                    "POST /projects with project name in different letter case but same value (e.g. \"dni test\" vs \"Dni Test\") — expect 201 Created or 400 duplicate name (same as TC_001)")
    ...
    @Test(
            priority = 11,
            description =
                    "POST /projects with project name having leading and trailing spaces (\" DNI Test \") — expect 201 Created or 400 duplicate name (same as TC_001)")
    ...
    public void TC_012_Send_POST_request_with_null_as_project_name() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithNullName())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_013_Send_POST_request_with_very_long_name_spaces_and_symbols_within_max_length() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithLongSpacesSymbolsName())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_014_Send_POST_request_with_valid_domain_example_com() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.validFullProjectCreatePayloadWithNameAndDomain(
    ...
    public void TC_015_Send_POST_request_without_domain_field() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithoutDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_016_Send_POST_request_with_empty_string_as_domain() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithEmptyDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_017_Send_POST_request_with_only_spaces_in_domain() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithSpaceOnlyDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_018_Send_POST_request_with_domain_length_exactly_200_characters() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithMaxLengthDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_019_Send_POST_request_with_domain_length_more_than_200_characters() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithDomainOverMaxLength())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_020_Send_POST_request_with_invalid_domain_format_abc() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithInvalidDomainFormatAbc())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_021_Send_POST_request_with_domain_missing_tld() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDomainMissingTld())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_022_Send_POST_request_with_domain_having_special_characters() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDomainSpecialCharacters())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_023_Send_POST_request_with_domain_having_spaces() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDomainHavingSpaces())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_024_Send_POST_request_with_valid_subdomain_example_com() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithValidSubdomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_025_Send_POST_request_with_uppercase_domain_example_com() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithUppercaseDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_026_Send_POST_request_with_domain_leading_trailing_spaces() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithDomainLeadingTrailingSpaces())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_027_Send_POST_request_with_null_as_domain() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithNullDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_028_Send_POST_request_with_numeric_domain_123_com() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithNumericDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_029_Send_POST_request_with_hyphenated_domain_my_site_com() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithHyphenatedDomain())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_030_Send_POST_request_with_domain_starting_with_hyphen() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDomainStartingWithHyphen())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_031_Send_POST_request_with_domain_ending_with_hyphen() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDomainEndingWithHyphen())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_032_Send_POST_request_with_domain_consecutive_dots() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDomainConsecutiveDots())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_033_Send_POST_request_with_https_url_as_domain() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDomainAsHttpsUrl())
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
                        .extract()
    ...
    public void TC_034_Send_POST_request_without_description_field() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithoutDescriptionField(
    ...
    public void TC_035_Send_POST_request_with_valid_description() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.validFullProjectCreatePayloadWithNameDomainAndDescription(
                                        uniqueName,
    ...
    public void TC_045_Send_POST_request_without_connections_field() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithoutConnectionsField(
    ...
    public void TC_046_Send_POST_request_with_empty_connections_object() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithEmptyConnectionsObject(
                                        uniqueName, LyticsProjectTestData.VALID_DOMAIN, description))
                .when()
                        .post(ApiPaths.PROJECTS)
                .then()
    ...
    public void TC_048_Send_POST_request_with_duplicate_connection_ids_deduplicated_in_response() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithDuplicateConnectionEntries(uniqueName))
                        .when()
                        .post(ApiPaths.PROJECTS)
                        .then()
                        .extract()
    ...
    public void TC_049_Send_POST_request_with_only_valid_stackApiKeys_in_connections() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithConnectionsOnlyStackApiKeys(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
    ...
    public void TC_050_Send_POST_request_with_only_valid_launchProjectUids_in_connections() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithConnectionsOnlyLaunchProjectUids(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_051_Send_POST_request_with_only_valid_personalizeProjectUids_in_connections() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithConnectionsOnlyPersonalizeProjectUids(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_052_Send_POST_request_with_stack_personalize_and_empty_string_in_launchProjectUids() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithStackPersonalizeAndLaunchIncludingEmptyString(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_053_Send_POST_request_with_launch_personalize_and_empty_stackApiKeys() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithLaunchPersonalizeAndEmptyStackApiKeys(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_054_Send_POST_request_with_stack_launch_and_empty_string_in_personalizeProjectUids() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithStackLaunchAndPersonalizeIncludingEmptyString(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_055_Send_POST_request_with_all_connection_fields_empty_strings() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithAllConnectionArraysContainingOnlyEmptyStrings(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_056_Send_POST_request_with_invalid_stackApiKeys_and_valid_launch_personalize() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithInvalidStackApiKeyAndValidLaunchPersonalize(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_057_Send_POST_request_with_invalid_launchProjectUids_and_valid_stack_personalize() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithValidStackPersonalizeAndInvalidLaunchProjectUid(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_058_Send_POST_request_with_invalid_personalizeProjectUids_and_valid_stack_launch() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithValidStackLaunchAndInvalidPersonalizeProjectUid(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_059_Send_POST_request_with_duplicate_values_in_stackApiKeys_array_only() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDuplicateStackApiKeysOnly(uniqueName))
                        .when()
                        .post(ApiPaths.PROJECTS)
                        .then()
                        .extract()
    ...
    public void TC_060_Send_POST_request_with_non_string_values_in_connection_arrays() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithNonStringConnectionValues(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_061_Send_POST_request_with_extra_unknown_field_inside_connections() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(
                                LyticsProjectTestData.projectCreatePayloadWithExtraUnknownFieldInConnections(
                                        uniqueName,
                                        LyticsProjectTestData.VALID_DOMAIN,
                                        LyticsProjectTestData.VALID_DESCRIPTION))
                        .when()
    ...
    public void TC_062_Send_second_POST_with_same_connections_different_project_name_expect_duplicate_connection() {
        ...
        Response first =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithName(firstProjectName))
                        .when()
                        .post(ApiPaths.PROJECTS)
                        .then()
                        .extract()
        ...
        Response second =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.validFullProjectCreatePayloadWithName(secondProjectName))
                        .when()
                        .post(ApiPaths.PROJECTS)
                        .then()
                        .extract()
    ...
    public void TC_063_Send_POST_with_connection_uids_from_different_organization_expect_not_found_each_field() {
        ...
        Response response =
                given()
                        .spec(lyticsRequestSpec)
                        .body(LyticsProjectTestData.projectCreatePayloadWithDifferentOrganizationConnections(uniqueName))
                        .when()
                        .post(ApiPaths.PROJECTS)
                        .then()
                        .extract()
